...
long CeXGem::GEMRspRemoteCommand2(long nMsgId, LPCTSTR sCmd, long nHCAck, long nCount, BSTR* psCpName, long* pnCpAck)
{
	long result;
	static BYTE parms[] =
		VTS_I4 VTS_BSTR VTS_I4 VTS_I4 VTS_PBSTR VTS_PI4;
	InvokeHelper(0x66, DISPATCH_METHOD, VT_I4, (void*)&result, parms,
		nMsgId, sCmd, nHCAck, nCount, psCpName, pnCpAck);
	return result;
}

long CeXGem::GEMReqPPFmtSend2(LPCTSTR sPpid, LPCTSTR sMdln, LPCTSTR sSoftRev, long nCount, BSTR* psCCode, long* pnParamCount, BSTR* psParamNames, BSTR* psParamValues)
{
	long result;
	static BYTE parms[] =
		VTS_BSTR VTS_BSTR VTS_BSTR VTS_I4 VTS_PBSTR VTS_PI4 VTS_PBSTR VTS_PBSTR;
	InvokeHelper(0x67, DISPATCH_METHOD, VT_I4, (void*)&result, parms,
		sPpid, sMdln, sSoftRev, nCount, psCCode, pnParamCount, psParamNames, psParamValues);
	return result;
}

long CeXGem::GEMRspPPFmt2(long nMsgId, LPCTSTR sPpid, LPCTSTR sMdln, LPCTSTR sSoftRev, long nCount, BSTR* psCCode, long* pnParamCount, BSTR* psParamNames, BSTR* psParamValues)
{
	long result;
	static BYTE parms[] =
		VTS_I4 VTS_BSTR VTS_BSTR VTS_BSTR VTS_I4 VTS_PBSTR VTS_PI4 VTS_PBSTR VTS_PBSTR;
	InvokeHelper(0x68, DISPATCH_METHOD, VT_I4, (void*)&result, parms,
		nMsgId, sPpid, sMdln, sSoftRev, nCount, psCCode, pnParamCount, psParamNames, psParamValues);
	return result;
}
