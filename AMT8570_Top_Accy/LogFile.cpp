...
/********************************************************************/
CLogFile::OnCreateDirectories(CString strFileName) 
{
	...
	// Main에 공유폴더를 접속하여 Log를 남기는 방식.
	// PC가 꺼져 있거나 할 경우에는 Log를 남기기 힘듬
	// 에러 또한 늦게 뜨기 때문에 알기 쉽지 않은 문제가 있음.
// 	CString strDRVName, strFolder = "";
// 
// 	int  nDrive, nPer;
// 
...
// 			if (nCount == 0)
// 			{
// 				testa = strFileName.Find('\\', 4);
// 			}
// 			else
// 			{
// 				testa = strFileName.Find('\\', 1);
// 			}
// 
// 			if (testa == -1)
// 			{
...
// 			}
// 
// 			int a = strFileName.GetLength();
// 			strFolder += strFileName.Mid(0, testa);
// 			strFileName = strFileName.Mid(testa);
// 			if (nCount > 1)
// 			{
// 				CFileFind find;
// 				BOOL bResult = find.FindFile(strFolder + "\\");
// 				find.Close();
// 
// 				if (!bResult)
// 				{
